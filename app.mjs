...
function overview() {
  ...
  return `${pageTitle('CONTIGOO STUDIO / MANAGEMENT WORKSPACE', 'Build. Deliver. Keep managing.', 'Your clients, solutions and ongoing changes in one workspace.', newProjectButton)}
